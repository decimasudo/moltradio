...
module.exports = {
	...
	theme: {
		...
		extend: {
			fontFamily: {
				// A technical, robust font stack for a music tool feel
				sans: [
					'Inter',
					'-apple-system',
					'BlinkMacSystemFont',
			...
			colors: {
				...
				// Custom brand specific semantic colors
			...
			backgroundImage: {
				// Adds texture to avoid the flat digital look
			...
			keyframes: {
				...
				// A subtle "breathing" effect for live elements
				'pulse-subtle': {
					'0%, 100%': { opacity: 1 },
					'50%': { opacity: 0.8 },
				},
				// For equalizers or active states
				'equalizer': {
					'0%, 100%': { height: '20%' },
					'50%': { height: '100%' },
				},
